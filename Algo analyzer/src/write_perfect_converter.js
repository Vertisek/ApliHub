...
const targetFile = path.resolve(__dirname, '../../Fast Konwerter/js/converter-app.js');

const code = `/* Fast Konwerter (ReTrap) - In-Browser Test Suite & Live Converter */
...
console.log('[PERFECT FIX] Wrote Fast Konwerter converter-app.js');

// Validate syntax with node -c
try {
  execSync('node -c "' + targetFile + '"');
  console.log('[SYNTAX VALIDATED] Node -c passed without errors!');
} catch (err) {
